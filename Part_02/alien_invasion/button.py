...
class Button():
    ...
    def __init__(self, ai_settings, superficie, msg):
        ...
        self.rect.center = self.superficie_rect.center
    ...
    def draw_button(self):
        ...
        self.superficie.fill(self.button_color, self.rect)
        self.superficie.blit(self.msg_image, self.msg_image_rect)